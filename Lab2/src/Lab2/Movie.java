...
public class Movie {
	//ïåğåğàõóâàííÿ çì³ííèõ êëàñó
		...
		//ìåòîäè êëàñó
		 ...
		 public void print_Movie(){//âèâîäèòü íà åêğàí ³íôîğìàö³ş ïğî ô³ëüì
			 result=print_name+": '"+this.name+"',\t"+print_year+": "+this.year+",\t "+print_studio+": '"+this.movie_studio+"', "+print_director+": "+this.director;
			 System.out.println(result);

		 }
		 public void print_Movie_Upper(){//âèâîäèòü íà åêğàí ³íôîğìàö³ş ïğî ô³ëüì ç âåğõí³ì ğåã³ñòğîì
			 result=print_name+": '"+this.name+"',\t"+print_year+": "+this.year+",\t"+print_studio+": '"+this.movie_studio+"', "+print_director+": "+this.director;
			 System.out.println(result.toUpperCase());

		 }
		 
		 public int get_number() {//ïîâåğòàº ïîğÿäêîâèé íîìåğ ô³ëüìó
			 return ++number;
		 }
}
